...
*Auto-maintained by Stop hook (`/.claude/hooks/update-architecture.sh`). Last updated: 2026-07-01 session 2 (re-validated all streaming pipeline files — no structural changes; all documentation below confirmed accurate).*
